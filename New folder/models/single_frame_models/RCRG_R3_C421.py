"""
RCRG-R3-C421 (RCRG-3R-421C) Description:
--------------------------------
...
def eval(root, config, checkpoint_path):
    ...
    prefix = "Group Activity RCRG-R3-C421 eval on testset"
...
if __name__ == "__main__":
    ...
    CONFIG_PATH = f"{ROOT}/configs/RCRG_R3_C421.yml"
    MODEL_CHECKPOINT = f"{ROOT}/experiments/RCRG_R3_C421_V1_2025_03_08_23_56/checkpoint_epoch_22.pkl"
